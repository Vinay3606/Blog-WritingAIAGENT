...
with st.sidebar:
    ...
    past_files = st.session_state.get("past_files", list_past_blogs())
    if not past_files:
...
if run_btn:
    ...
    for kind, payload in try_stream(app, inputs):
        if kind in ("updates", "values"):
            ...
            # ✅ Refresh past blogs list after new blog is saved
            st.session_state["past_files"] = list_past_blogs()
        ...
        if not specs and not images_dir.exists():
            ...
            if specs:
                ...
                try:
                    ...
                    st.warning('Invalid image specs format')
